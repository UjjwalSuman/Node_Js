...
module.exports.fetchMenter = async (req, res) => {
  ...
  const data = await axios.patch('https://app.growthmentor.com/search', payload, {
    headers: {
      'Connection': 'keep-alive',
      'sec-ch-ua': '"Not;ABrand";v="99","GoogleChrome";v="91","Chromium";v="91"',
      'Accept': 'application/json,text/plain,/',
      'X-CSRF-TOKEN': 'Pr0FngISQc73NEV9JQRUdEuHvkwoHeFK8yTUs/GPX44zDJgmeCbJVM9ZAvDe/KxyT0hg/DhFljfht7nTT1Hp5w==',
